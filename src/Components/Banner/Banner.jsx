  ...
  return (
    <>
      <div className="w-full md:h-[38rem] h-[15rem] z-0  bg-slate-300 bg-blur relative flex mb-20">
        ...
        <div className="h-28 md:h-40 w-5 md:w-10 fixed z-90 bg-yellow-500 bg-opacity-50 hover:bg-opacity-90 rounded-tr-lg rounded-br-lg mt-11 md:mt-44 md:text-2xl text-sm flex flex-col justify-center gap-2 items-center m-0 p-0">
