...
export default function About() {
  ...
  return (
    <div className="w-[100%] h-fit bg-transparent">
      <div className="w-[100%] h-20 bg-transparent flex justify-center items-center text-2xl font-bold">
        About Us
      </div>
        ...
        <div className=" w-[100%] h-fit md:w-[80%]">
          <div className="w-[100%] h-fit ">
            <p className="px-10 bg-transparent first-letter:font-bold first-letter:text-lg">
              ...
              nurturing minds, fostering creativity, and empowering individuals
              to reach their full potential.Here&apos;s a glimpse into who we
              are and what sets us apart:
            </p>
          </div>
              ...
              <div className="border rounded-md mb-2">
                ...
                >
                  <p className="text-black">
                    ...
                    technologies and methodologies to enhance the learning
                    experience.
                  </p>
                </div>
              </div>
              ...
              <div className="border rounded-md">
                ...
                >
                  <p className="text-black">
                    ...
                    educators, and the community, recognizing that collective
                    efforts lead to greater achievements.
                  </p>
                </div>
              </div>
            </div>
