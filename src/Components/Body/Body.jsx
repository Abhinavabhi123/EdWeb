...
export default function Body() {
  return (
    <div className="body_card_wrapper pb-20">
      <div className="body_card mb-10 w-[90%] md:w-[380px]">
        ...
        <div className="card_info md:h-72">
          ...
          <p className="w-20 text-center pt-2 h-10 rounded-md bg-text_color" href="">
            Check
          </p>
        </div>
      </div>
      <div className="body_card w-[90%] mb-10 md:w-[380px] md:h-fit">
        ...
        <div className="card_info">
          <h1>Middle School</h1>
          <p>
            Where students often stay with one or two
            teachers for most of the school day, middle school is usually the
            first time in which students change teachers after each class of
            usually about one hour. Students often study 6 subjects. They will
            be taught by a different teacher for each subject.
          </p>
          <p className="w-20 text-center pt-2 rounded-md h-10 bg-text_color" href="">
            Check
          </p>
        </div>
      </div>
