...
export default function HeaderMain() {
  ...
  return (
    <>
      <div className="w-[100%] h-[9rem]  bg-transparent dark:bg-white max-[1290px]:h-[5.5rem] flex items-center justify-between px-2 shadow-md min-[1207px]:px-[15%] z-40 ">
        <img src="/logo.svg" alt="logo" className="w-24 md:w-28 h-auto" />
        <div className="w-[90%] h-full bg-transparent flex flex-col items-end justify-center">
          <div className="w-[100%] h-[50%] bg-transparent flex items-center justify-end md:gap-3 gap-1 text-text_color text-lg">
            {/* details */}
            <NavDetails />
            {/* Search */}
