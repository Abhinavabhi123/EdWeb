      ...
      <nav className="w-full h-full flex justify-end items-center">
        <ul className="flex justify-end items-center w-full h-full text-lg font-semibold gap-10 pt-3 pe-2  text-text_color">
          <li className="navList group relative">
            We Are GEMS
            <ul className=" w-72 h-fit nav_animate z-50 absolute bg-white left-0 top-[3.8rem] p-2 border shadow-md rounded-md hidden group-hover:block hover:block">
              <li className="nav1">Message From Our Founder</li>
              ...
              <li className="nav1">Career at GEMS</li>
            </ul>
          </li>
          <li className="navList group relative">
            Our Promise
            <ul className="w-72 nav_animate h-fit z-50 absolute bg-white top-[3.8rem] left-0 hidden border shadow-md rounded-md group-hover:block group-hover/suite:block">
              <li className="nav1">The GEMS Difference</li>
              ...
              <li className="nav1 group/suite relative flex justify-between pe-2 items-center">
                ...
                <ul className="absolute nav_animate z-50 bg-white left-[18rem] top-0 w-72 h-fit border hidden rounded-md shadow-md group-hover/suite:block group/suite">
                  <li className="text-black nav1">Green Growth Statistics</li>
                  <li className="text-black nav1">Climate Literacy Lessons </li>
                  <li className="text-black nav1">Sustainable Initiatives</li>
                  <li className="text-black nav1">Sustainability Events</li>
                </ul>
              </li>
              <li className="nav1"> University & Career Pathway</li>
            </ul>
          </li>
          <li className="navList group relative">
            Our Schools
            <ul className=" w-72 nav_animate h-fit z-50 absolute bg-white top-[3.55em] left-0 hidden group-hover:block group-hover/our:block shadow-md border rounded-md ">
              <li className="nav1 relative flex justify-between pe-2 items-center group/our">
              ...
              <li className="nav1 relative group/UAE flex justify-between pe-2 items-center">
                Schools in UAE
                <p>&#62;</p>
                <ul className="absolute nav_animate z-50 bg-white left-[18rem] top-0 w-72 h-48 border hidden rounded-md shadow-md group-hover/UAE:block group/our">
                  <li className="nav1 text-black">All Schools in Dubai</li>
                  <li className="nav1 text-black">All Schools in Abu Dhabi & Al Aii</li>
                  <li className="nav1 text-black">All Schools in Sharjah</li>
                  <li className="nav1 text-black h-16"> All Schools in Ras Al Khaimah and Fujairah</li>
                </ul>
              </li>
              <li className="nav1">All Our Schools</li>
              <li className="nav1">KHDA Outstanding Schools in Dubai</li>
              <li className="nav1">What Our Parents Say</li>
            </ul>
          </li>
          <li className="navList relative group">
            Our Students
            <ul className=" nav_animate w-72 h-fit z-50 p-2 absolute bg-white left-0 top-[3.8rem] rounded-md shadow-md border hidden group-hover:block">
              <li className="nav1">Our Alumni - where are tye now ?</li>
              <li className="nav1">Student Experiences</li>
            </ul>
          </li>
          <li className="navList  relative group">
            News & Events
            <ul className="w-72 nav_animate h-fit z-50 absolute bg-white p-2 left-0 top-[3.8rem] rounded-md shadow-md border hidden group-hover:block">
              <li className="nav1">News</li>
              <li className="nav1">GEMS Education Blogs</li>
              <li className="nav1">Open School Events</li>
            </ul>
          </li>
          <li className="navList relative group">
            For Parents
            <ul className="w-72 nav_animate h-fit p-2 z-50 absolute  top-[3.8rem] bg-white rounded-md border shadow-md hidden group-hover:block">
              <li className="nav1">School of Thought: Podcast</li>
              ...
              <li className="nav1">GEMS Alumni App</li>
            </ul>
          </li>
        </ul>
      </nav>
